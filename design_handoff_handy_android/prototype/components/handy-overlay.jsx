  ...
  return (
    <GlassCard theme={theme} radius={28} intensity={75}
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "flex-start", gap: 12, marginBottom: padding - 2 }}>
          ...
          {/* Icons aligned to the title row, not centered against the stack */}
          <div style={{ display: "flex", alignItems: "center", gap: 2,
                        height: Math.max(handSize, titleSize * 1.1) }}>
