...
class RecipeIntentRouter(
    ...
    companion object {
        val INTENT_TO_RECIPE_ID: Map<RecipeIntent, String> = mapOf(
            ...
            RecipeIntent.CREATE_CALENDAR_EVENT to "create_calendar_event_v2",
            ...
            RecipeIntent.YOUTUBE_SEARCH to "youtube",
            RecipeIntent.YOUTUBE_OPEN_CHANNEL to "youtube",
            RecipeIntent.CREATE_NOTE to "notes",
            RecipeIntent.OPEN_CONTACT to "contacts",
            RecipeIntent.PREPARE_CALL to "contacts",
            RecipeIntent.PREPARE_SMS to "contacts",
            RecipeIntent.FILES_SEARCH to "files",
            RecipeIntent.FILES_OPEN to "files",
            RecipeIntent.PHOTOS_OPEN to "photos",
            RecipeIntent.PHOTOS_SHARE_CURRENT to "photos",
            RecipeIntent.CALCULATE to "calculator",
            RecipeIntent.FOOD_SEARCH to "food_delivery",
            RecipeIntent.FOOD_TRACK_ORDER to "food_delivery",
        )
