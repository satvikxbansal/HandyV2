...
object PromptCatalog {
    ...
    val AGENT_RECIPE_ADDENDUM: String = """
        ...
        - book_ride: args include destination and optional app (uber, ola, or rapido). example: book a cab to airport → [INTENT:book_ride]. for book_ride, Handy will prepare the booking but the user must tap Confirm/Request themselves.
